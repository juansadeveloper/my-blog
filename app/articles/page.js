  ...
  return (
    <main className="w-full m-auto flex flex-col items-center min-h-screen  bg-[#f5f5f5] ">
        ...
        <div className="w-full  mt-10 font-serif  flex flex-col justify-between items-center gap-5 p-10">
            ...
            <div className="rounded flex flex-col md:flex-row md:justify-start md:items-center md:gap-5 min-w-[300px] w-full md:w-[720px] md:h-20 bg-[#f5f5f5] shadow hover:shadow-lg px-2 py-5">
